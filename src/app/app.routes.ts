...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'checkout',
        loadComponent: () =>
          import('./features/checkout-flow/checkout/checkout').then((m) => m.Checkout),
        canActivate: [authGuard],
      },
      {
        path: 'about',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'reviews',
            loadComponent: () =>
              import('./features/account/reviews/reviews').then((m) => m.AccountReviews),
          },
          {
            path: 'addresses',
            loadComponent: () =>
          ...
          },
          {
            path: 'settings',
            loadComponent: () =>
              import('./features/account/settings/settings').then((m) => m.AccountSettings),
          },
        ],
      },
      {
        path: 'shippinginfo',
        loadComponent: () =>
          import('./features/static/shipping-info/shipping-info').then((m) => m.ShippingInfo),
      },
      {
        path: 'orderconfirmation',
        loadComponent: () =>
          import('./features/checkout-flow/order-confirmation/order-confirmation').then(
      ...
      },
      {
        path: 'paymentmethods',
        loadComponent: () =>
          import('./features/static/payment-methods/payment-methods').then((m) => m.PaymentMethods),
      },
      {
        path: 'privacy',
      ...
      },
      {
        path: 'returnpolicy',
        loadComponent: () =>
          import('./features/static/return-policy/return-policy').then((m) => m.ReturnPolicy),
      },
      {
        path: 'support',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'products',
        loadComponent: () =>
          import('./features/admin/products/getall/getall').then((m) => m.ProductListComponent),
      },
      {
        path: 'products/edit/:id',
        loadComponent: () =>
          import('./features/admin/products/edit/edit').then((m) => m.ProductEditComponent),
      },
      {
        path: 'products/add',
        loadComponent: () =>
          import('./features/admin/products/add/add').then((m) => m.ProductAddComponent),
      },
      {
        path: 'categories',
        loadComponent: () => import('./features/admin/categories/list/list').then((m) => m.List),
      },
      {
        path: 'categories/edit/:id',
        loadComponent: () => import('./features/admin/categories/edit/edit').then((m) => m.Edit),
      },
      {
        path: 'categories/add',
        loadComponent: () => import('./features/admin/categories/add/add').then((m) => m.Add),
      },
      {
        path: 'brands',
      ...
      },
      {
        path: 'orders',
        loadComponent: () =>
          import('./features/admin/orders/orders').then((m) => m.OrdersListComponent),
      },
      {
        path: 'orders/edit/:id',
        loadComponent: () =>
          import('./features/admin/orders/edit-order/edit-order').then((m) => m.OrderEditComponent),
      },
      {
        path: 'users',
        loadComponent: () =>
